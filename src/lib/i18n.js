...
const translations = {
  es: {
    ...
    youSave: "Ahorras",
    youPayMore: "Pagas",
    moreThanCheapest: "más que la más barata",
    vsExpensive: "vs la más cara",
    perTank: "por depósito",
  },
  en: {
    ...
    youSave: "You save",
    youPayMore: "You pay",
    moreThanCheapest: "more than cheapest",
  ...
  eu: {
    ...
    dieselPlus: "Diesel+",
    favorites: "Gogokoak",
    showFavorites: "Gogokoak bakarrik",
    showAll: "Denak",
    priceUp: "igo da",
    priceDown: "jaitsi da",
    sinceLastVisit: "azken bisitalditik",
    allBrands: "Denak",
    filterByBrand: "Marka",
    tankSize: "Depositua",
    liters: "L",
    youSave: "Aurrezten duzu",
    youPayMore: "Ordaintzen duzu",
    moreThanCheapest: "merkeena baino gehiago",
    vsExpensive: "garestiena baino",
    perTank: "depositu bakoitzeko",
  },
};
